...
crypto_coin_holding <- crypto_trade_price %>%
  mutate(holding= ifelse(trade_price!=Inf, close / trade_price, 0))
...
holdings %>% ggplot(aes(x = "", y= holding_coin_perc, fill=coin)) + geom_bar(stat = "identity") + coord_polar(theta = "y")
